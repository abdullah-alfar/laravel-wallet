...
<body>
            ...
            <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-right top-menu">
                        ...
                        <li class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <img height="50" width="50" alt="" src="/storage/avatars/{{Auth::guard('client')->user()->avatar}}">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" href="{{ route('logout') }}"><i class="fa fa-unlock-alt"></i> LogOut</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="footer-bottom-widget">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            &copy; 2020 <strong>e</strong>-Wallet<strong>.</strong></p>
                        </div>
                        <div class="col-sm-6">
    ...
    <script src="{{ asset('client/js/sparkline-chart.js')}}"></script>
